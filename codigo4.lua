...
local function abrirMenuCheats()
    local cheatsMenu = criarFrame(UDim2.new(0,300,0,200), UDim2.new(0.5, -150, 0.5, 60), Color3.fromRGB(35,35,35))
    ...
    botaoTP.Size = UDim2.new(0, 260, 0, 30)
    botaoTP.Position = UDim2.new(0, 20, 0, 140)
    botaoTP.Text = "TP Todos"
    botaoTP.Font = Enum.Font.SourceSansBold
    botaoTP.TextSize = 18
    botaoTP.BackgroundColor3 = Color3.fromRGB(255, 85, 0)
        ...
        for _, plr in pairs(Players:GetPlayers()) do
            if plr ~= player then
                ...
                if char and char:FindFirstChild("HumanoidRootPart") then
                    char.HumanoidRootPart.CFrame = hrp.CFrame + Vector3.new(math.random(-5, 5), 0, math.random(-5, 5))
                end
            end
        end
    end)
