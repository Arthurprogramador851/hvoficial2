...
local function abrirMenuPrincipal()
    local menu = criarFrame(UDim2.new(0,300,0,100), UDim2.new(0.5, -150, 0.5, -50), Color3.fromRGB(25,25,25))
    ...
    -- Depois de 5 segundos abrir menu de cheats
    delay(5, function()
        abrirMenuCheats()
    end)
end
...
local function abrirMenuCheats()
    local cheatsMenu = criarFrame(UDim2.new(0,300,0,150), UDim2.new(0.5, -150, 0.5, 60), Color3.fromRGB(35,35,35))
