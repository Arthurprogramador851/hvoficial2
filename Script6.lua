...
local function abrirMenuPrincipal()
    if menuPrincipal then menuPrincipal:Destroy() end
    menuPrincipal = criarFrame(UDim2.new(0, 320, 0, 100), UDim2.new(0.5, -160, 0.5, -50), Color3.fromRGB(50,50,50))
    criarBotaoFechar(menuPrincipal)

    local label = Instance.new("TextLabel", menuPrincipal)
